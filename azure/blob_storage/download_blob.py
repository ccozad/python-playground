...
if __name__ == "__main__":
    ...
    if container_client.exists():
        ...
        if blob_client.exists():
            print('Blob {} exists'.format(blob_name))
            download_stream = blob_client.download_blob()
            content = download_stream.readall()
            print('Contents of blob: {}'.format(content))
        else:
            print('Blob {} does not exist, unable to download blob!'.format(blob_name))
    else:
        print('Container {} does not exist, unable to download blob!'.format(container_name))
